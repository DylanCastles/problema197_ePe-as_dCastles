...
<body style="background: #BFBFBF; height: 100vh; display: flex; justify-content: center; align-items: center;">
    <div class="card bg-secondary text-white" style="width: 25%; padding: 20px;">
        ...
        <form action="validacion1.php" method="post" style="align-items: center;">
            ...
            <input type="submit" name="desencriptar" class="btn btn-success" value="Desencriptar X^II -> X^I" style="margin-left: auto; margin-right:auto">
            <input type="submit" name="desencriptar_X" class="btn btn-success" value="X" style="margin-left: auto; margin-right:auto"><br><br>
            <input type="submit" name="encriptar" class="btn btn-danger" value="Encriptar X -> X^I">
            <input type="submit" name="encriptar_xII" class="btn btn-danger" value="X^II">
